                        ...
                        try {
                            ...
                            if (object.getBoolean("success")) {
                                ...
                                for (int i = 0; i < array.length(); i++) {
                                    ...
                                    Level employee = new Level();
                                    employee.setStudent_id(level_object.getInt("student_id"));
                                    employee.setLevel_id(level_object.getInt("level_id"));
                                    employee.setName(level_object.getString("name"));
                                  //  employee.setUrlImage(level_object.getString("url_image"));

                                    list_levels.add(employee);
