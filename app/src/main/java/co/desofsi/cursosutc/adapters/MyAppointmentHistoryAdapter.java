...
public class MyAppointmentHistoryAdapter extends RecyclerView.Adapter<MyAppointmentHistoryAdapter.SpecialtyHolder> {

    private Context context;
    private ArrayList<AppointmentDescription> list;

    public MyAppointmentHistoryAdapter(Context context, ArrayList<AppointmentDescription> list) {
    ...
    public SpecialtyHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_fragment__recycler_my_appointments_history, parent, false);
