...
import co.desofsi.cursosutc.activities.DetailPaymentActivity;
import co.desofsi.cursosutc.activities.HomeActivity;
import co.desofsi.cursosutc.models.Payments;

public class MyPaymentAdapter extends RecyclerView.Adapter<MyPaymentAdapter.SpecialtyHolder> {

    private Context context;
    private ArrayList<Payments> list;

    public MyPaymentAdapter(Context context, ArrayList<Payments> list) {
    ...
    public SpecialtyHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_fragment__recycler_my_payments, parent, false);
    ...
    public void onBindViewHolder(@NonNull SpecialtyHolder holder, final int position) {
        ...
        try {
            ...
            holder.txt_name_specialty.setText(payments.getName_s());
            holder.txt_name_doctor.setText("Dr. " + payments.getName_d()
            ...
            switch (payments.getStatus()) {
                case "cancelado":
                    holder.image_doctor.setImageResource(R.drawable.ic_baseline_check_circle_outline_24);
                    break;
                case "proceso":
                    holder.image_doctor.setImageResource(R.drawable.ic_baseline_progress_24);
                    break;
                case "anulado":
                    holder.image_doctor.setImageResource(R.drawable.ic_baseline_close_24);
                    break;
            }
