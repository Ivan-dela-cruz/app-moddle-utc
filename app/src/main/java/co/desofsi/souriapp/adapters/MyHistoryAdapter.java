...
public class MyHistoryAdapter extends RecyclerView.Adapter<MyHistoryAdapter.SpecialtyHolder> {

    private Context context;
    private ArrayList<Treatment> list;

    public MyHistoryAdapter(Context context, ArrayList<Treatment> list) {
